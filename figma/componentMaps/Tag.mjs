...
export default {
  ...
  props: {
    ...
    variant: {
      ...
      kind: 'enum',
      values: {
        noFill: 'TagsTypes.NoFill',
        attentive: 'TagsTypes.Attentive',
        subtle: 'TagsTypes.Subtle',
      },
    },
    size: {
      figmaProp: 'size',
    ...
    color: {
      ...
      kind: 'enum',
      values: {
        neutral: 'SplitTagTypes.Neutral',
        primary: 'SplitTagTypes.Primary',
        success: 'SplitTagTypes.Success',
        error: 'SplitTagTypes.Error',
        warning: 'SplitTagTypes.Warning',
        purple: 'SplitTagTypes.Purple',
      },
    },
    shape: {
      figmaProp: 'shape',
