// SCAFFOLD generated by scripts/scaffold-figma-component-maps.mjs from src/MultiSelectV2SubMenu.res.
...
export default {
  ...
  codeComponent: 'MultiSelectV2SubMenu',
  id: 'multiSelectV2SubMenu',
