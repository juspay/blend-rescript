// SCAFFOLD generated by scripts/scaffold-figma-component-maps.mjs from src/BlendChartContainer.res.
...
export default {
  ...
  codeComponent: 'BlendChartContainer',
  id: 'blendChartContainer',
