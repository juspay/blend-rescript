...
// apps/storybook/stories/components/TextInput/NumberInput.figma.tsx (branch: main). Do NOT hand-edit -- edit nothing here;
...
// referenced against our own generated src/NumberInput.res --
...
export default {
  figmaComponentName: 'NumberInput',
  ...
  props: {
    ...
    preventNegative: { mapped: false, reason: 'not present in blend-design-system\'s published .figma.tsx' },
  },
}
