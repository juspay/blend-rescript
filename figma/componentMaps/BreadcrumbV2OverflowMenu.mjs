// SCAFFOLD generated by scripts/scaffold-figma-component-maps.mjs from src/BreadcrumbV2OverflowMenu.res.
...
export default {
  ...
  codeComponent: 'BreadcrumbV2OverflowMenu',
  id: 'breadcrumbV2OverflowMenu',
