...
// apps/storybook/stories/components/TextInput/TextArea.figma.tsx (branch: main). Do NOT hand-edit -- edit nothing here;
...
// referenced against our own generated src/TextArea.res --
...
export default {
  ...
  props: {
    ...
    placeholder: { figmaProp: 'placeholder', kind: 'string' },
    disabled: {
      figmaProp: 'state',
      kind: 'enum',
      values: {
    ...
    resize: { mapped: false, reason: 'not present in blend-design-system\'s published .figma.tsx' },
    wrap: { mapped: false, reason: 'not present in blend-design-system\'s published .figma.tsx' },
  },
}
