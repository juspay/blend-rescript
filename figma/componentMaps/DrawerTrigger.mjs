// SCAFFOLD generated by scripts/scaffold-figma-component-maps.mjs from src/DrawerTrigger.res.
...
export default {
  ...
  props: {
    ...
    // TODO (unsupported): onClick -- unit => unit -- event handler, code-only
  },
}
