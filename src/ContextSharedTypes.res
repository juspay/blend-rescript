...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1owcx =
  ...
  | @as("unset") Unset
  | @as("-moz-fit-content") MozFitContent
  | @as("-moz-max-content") MozMaxContent
  | @as("-moz-min-content") MozMinContent
  | @as("-webkit-fit-content") WebkitFitContent
  | @as("-webkit-max-content") WebkitMaxContent
  | @as("auto") Auto
  | @as("fit-content") FitContent
  | @as("intrinsic") Intrinsic
  | @as("max-content") MaxContent
  | @as("min-content") MinContent
  | @as("min-intrinsic") MinIntrinsic
  | @as("-webkit-min-content") WebkitMinContent
  | Num(float)
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1x0av =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1wbzz =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtchhntk =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcgjquu =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("antiquewhite") Antiquewhite
  | @as("aqua") Aqua
  | @as("aquamarine") Aquamarine
  | @as("azure") Azure
  | @as("beige") Beige
  | @as("bisque") Bisque
  | @as("black") Black
  | @as("blanchedalmond") Blanchedalmond
  | @as("blue") Blue
  | @as("blueviolet") Blueviolet
  | @as("brown") Brown
  | @as("burlywood") Burlywood
  | @as("cadetblue") Cadetblue
  | @as("chartreuse") Chartreuse
  | @as("chocolate") Chocolate
  | @as("coral") Coral
  | @as("cornflowerblue") Cornflowerblue
  | @as("cornsilk") Cornsilk
  | @as("crimson") Crimson
  | @as("cyan") Cyan
  | @as("darkblue") Darkblue
  | @as("darkcyan") Darkcyan
  | @as("darkgoldenrod") Darkgoldenrod
  | @as("darkgray") Darkgray
  | @as("darkgreen") Darkgreen
  | @as("darkgrey") Darkgrey
  | @as("darkkhaki") Darkkhaki
  | @as("darkmagenta") Darkmagenta
  | @as("darkolivegreen") Darkolivegreen
  | @as("darkorange") Darkorange
  | @as("darkorchid") Darkorchid
  | @as("darkred") Darkred
  | @as("darksalmon") Darksalmon
  | @as("darkseagreen") Darkseagreen
  | @as("darkslateblue") Darkslateblue
  | @as("darkslategray") Darkslategray
  | @as("darkslategrey") Darkslategrey
  | @as("darkturquoise") Darkturquoise
  | @as("darkviolet") Darkviolet
  | @as("deeppink") Deeppink
  | @as("deepskyblue") Deepskyblue
  | @as("dimgray") Dimgray
  | @as("dimgrey") Dimgrey
  | @as("dodgerblue") Dodgerblue
  | @as("firebrick") Firebrick
  | @as("floralwhite") Floralwhite
  | @as("forestgreen") Forestgreen
  | @as("fuchsia") Fuchsia
  | @as("gainsboro") Gainsboro
  | @as("ghostwhite") Ghostwhite
  | @as("gold") Gold
  | @as("goldenrod") Goldenrod
  | @as("gray") Gray
  | @as("green") Green
  | @as("greenyellow") Greenyellow
  | @as("grey") Grey
  | @as("honeydew") Honeydew
  | @as("hotpink") Hotpink
  | @as("indianred") Indianred
  | @as("indigo") Indigo
  | @as("ivory") Ivory
  | @as("khaki") Khaki
  | @as("lavender") Lavender
  | @as("lavenderblush") Lavenderblush
  | @as("lawngreen") Lawngreen
  | @as("lemonchiffon") Lemonchiffon
  | @as("lightblue") Lightblue
  | @as("lightcoral") Lightcoral
  | @as("lightcyan") Lightcyan
  | @as("lightgoldenrodyellow") Lightgoldenrodyellow
  | @as("lightgray") Lightgray
  | @as("lightgreen") Lightgreen
  | @as("lightgrey") Lightgrey
  | @as("lightpink") Lightpink
  | @as("lightsalmon") Lightsalmon
  | @as("lightseagreen") Lightseagreen
  | @as("lightskyblue") Lightskyblue
  | @as("lightslategray") Lightslategray
  | @as("lightslategrey") Lightslategrey
  | @as("lightsteelblue") Lightsteelblue
  | @as("lightyellow") Lightyellow
  | @as("lime") Lime
  | @as("limegreen") Limegreen
  | @as("linen") Linen
  | @as("magenta") Magenta
  | @as("maroon") Maroon
  | @as("mediumaquamarine") Mediumaquamarine
  | @as("mediumblue") Mediumblue
  | @as("mediumorchid") Mediumorchid
  | @as("mediumpurple") Mediumpurple
  | @as("mediumseagreen") Mediumseagreen
  | @as("mediumslateblue") Mediumslateblue
  | @as("mediumspringgreen") Mediumspringgreen
  | @as("mediumturquoise") Mediumturquoise
  | @as("mediumvioletred") Mediumvioletred
  | @as("midnightblue") Midnightblue
  | @as("mintcream") Mintcream
  | @as("mistyrose") Mistyrose
  | @as("moccasin") Moccasin
  | @as("navajowhite") Navajowhite
  | @as("navy") Navy
  | @as("oldlace") Oldlace
  | @as("olive") Olive
  | @as("olivedrab") Olivedrab
  | @as("orange") Orange
  | @as("orangered") Orangered
  | @as("orchid") Orchid
  | @as("palegoldenrod") Palegoldenrod
  | @as("palegreen") Palegreen
  | @as("paleturquoise") Paleturquoise
  | @as("palevioletred") Palevioletred
  | @as("papayawhip") Papayawhip
  | @as("peachpuff") Peachpuff
  | @as("peru") Peru
  | @as("pink") Pink
  | @as("plum") Plum
  | @as("powderblue") Powderblue
  | @as("purple") Purple
  | @as("rebeccapurple") Rebeccapurple
  | @as("red") Red
  | @as("rosybrown") Rosybrown
  | @as("royalblue") Royalblue
  | @as("saddlebrown") Saddlebrown
  | @as("salmon") Salmon
  | @as("sandybrown") Sandybrown
  | @as("seagreen") Seagreen
  | @as("seashell") Seashell
  | @as("sienna") Sienna
  | @as("silver") Silver
  | @as("skyblue") Skyblue
  | @as("slateblue") Slateblue
  | @as("slategray") Slategray
  | @as("slategrey") Slategrey
  | @as("snow") Snow
  | @as("springgreen") Springgreen
  | @as("steelblue") Steelblue
  | @as("tan") Tan
  | @as("teal") Teal
  | @as("thistle") Thistle
  | @as("tomato") Tomato
  ...
  | @as("wheat") Wheat
  | @as("white") White
  | @as("whitesmoke") Whitesmoke
  | @as("yellow") Yellow
  | @as("yellowgreen") Yellowgreen
  | @as("transparent") Transparent
  | @as("AccentColor") AccentColor
  | @as("AccentColorText") AccentColorText
  | @as("ActiveText") ActiveText
  | @as("ButtonBorder") ButtonBorder
  | @as("ButtonFace") ButtonFace
  | @as("ButtonText") ButtonText
  | @as("Canvas") Canvas
  | @as("CanvasText") CanvasText
  | @as("Field") Field
  | @as("FieldText") FieldText
  | @as("GrayText") GrayText
  | @as("Highlight") HighlightRevertEtcgjquu
  | @as("HighlightText") HighlightText
  | @as("LinkText") LinkText
  | @as("Mark") Mark
  | @as("MarkText") MarkText
  | @as("SelectedItem") SelectedItem
  | @as("SelectedItemText") SelectedItemText
  | @as("VisitedText") VisitedText
  | @as("ActiveBorder") ActiveBorder
  | @as("ActiveCaption") ActiveCaption
  | @as("AppWorkspace") AppWorkspace
  | @as("Background") Background
  | @as("ButtonHighlight") ButtonHighlight
  | @as("ButtonShadow") ButtonShadow
  | @as("CaptionText") CaptionText
  | @as("InactiveBorder") InactiveBorder
  | @as("InactiveCaption") InactiveCaption
  | @as("InactiveCaptionText") InactiveCaptionText
  | @as("InfoBackground") InfoBackground
  | @as("InfoText") InfoText
  | @as("Menu") Menu
  | @as("MenuText") MenuText
  | @as("Scrollbar") ScrollbarRevertEtcgjquu
  | @as("ThreeDDarkShadow") ThreeDDarkShadow
  | @as("ThreeDFace") ThreeDFace
  | @as("ThreeDHighlight") ThreeDHighlight
  | @as("ThreeDLightShadow") ThreeDLightShadow
  | @as("ThreeDShadow") ThreeDShadow
  | @as("Window") Window
  | @as("WindowFrame") WindowFrame
  | @as("WindowText") WindowText
  | @as("currentColor") CurrentColor
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcp2j1f =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1yz1q =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("FieldText") FieldText
  | @as("GrayText") GrayText
  | @as("Highlight") HighlightRevertEtc1yz1q
  | @as("HighlightText") HighlightText
  | @as("LinkText") LinkText
  | @as("Mark") Mark
  | @as("MarkText") MarkText
  ...
  | @as("Menu") Menu
  | @as("MenuText") MenuText
  | @as("Scrollbar") ScrollbarRevertEtc1yz1q
  | @as("ThreeDDarkShadow") ThreeDDarkShadow
  | @as("ThreeDFace") ThreeDFace
  | @as("ThreeDHighlight") ThreeDHighlight
  | @as("ThreeDLightShadow") ThreeDLightShadow
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcly7v7 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcsclw8 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("FieldText") FieldText
  | @as("GrayText") GrayText
  | @as("Highlight") HighlightRevertEtcsclw8
  | @as("HighlightText") HighlightText
  | @as("LinkText") LinkText
  | @as("Mark") Mark
  | @as("MarkText") MarkText
  ...
  | @as("Menu") Menu
  | @as("MenuText") MenuText
  | @as("Scrollbar") ScrollbarRevertEtcsclw8
  | @as("ThreeDDarkShadow") ThreeDDarkShadow
  | @as("ThreeDFace") ThreeDFace
  | @as("ThreeDHighlight") ThreeDHighlight
  | @as("ThreeDLightShadow") ThreeDLightShadow
  ...
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcz3a4s =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcydel2 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("ease-out") EaseOut
  | @as("step-end") StepEnd
  | @as("step-start") StepStart
  | @as("linear") Linear
  | @as("all") All
  | @as("allow-discrete") AllowDiscrete
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1avg4 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcrrza2 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcrldf7 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1mkx8 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("FieldText") FieldText
  | @as("GrayText") GrayText
  | @as("Highlight") HighlightRevertEtc1mkx8
  | @as("HighlightText") HighlightText
  | @as("LinkText") LinkText
  | @as("Mark") Mark
  | @as("MarkText") MarkText
  ...
  | @as("Menu") Menu
  | @as("MenuText") MenuText
  | @as("Scrollbar") ScrollbarRevertEtc1mkx8
  | @as("ThreeDDarkShadow") ThreeDDarkShadow
  | @as("ThreeDFace") ThreeDFace
  | @as("ThreeDHighlight") ThreeDHighlight
  | @as("ThreeDLightShadow") ThreeDLightShadow
  ...
  | @as("fixed") Fixed
  | @as("top") Top
  | @as("right") RightRevertEtc1mkx8
  | @as("bottom") Bottom
  | @as("left") LeftRevertEtc1mkx8
  | @as("center") CenterRevertEtc1mkx8
  | @as("no-repeat") NoRepeat
  | @as("repeat-x") RepeatX
  | @as("repeat-y") RepeatY
  | @as("round") Round
  | @as("space") SpaceRevertEtc1mkx8
  | @as("local") Local
  | @as("scroll") Scroll
  | @as("border-box") BorderBox
  | @as("content-box") ContentBox
  | @as("padding-box") PaddingBox
  | Num(float)
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
@set_index
external contextComponentTokensPOPOVERSmShadowConfigSet: (
  contextComponentTokensPOPOVERSmShadowConfig,
  string,
  mozInitialOrInheritOrInitialOrRevertEtcz3a4s,
) => unit = ""
...
type contextComponentTokensMULTISELECTSmTriggerBackgroundColorConfig = {
  ...
  @as("no-container")
  noContainer?: contextComponentTokensMULTISELECTSmTriggerBackgroundColorContainerConfig,
}
...
type contextComponentTokensMULTISELECTSmTriggerOutlineConfig = {
  ...
  @as("no-container")
  noContainer?: contextComponentTokensMULTISELECTSmTriggerOutlineContainerConfig,
}
...
type contextComponentTokensMULTISELECTSmTriggerSelectionTagConfig = {
  ...
  @as("no-container")
  noContainer?: contextComponentTokensMULTISELECTSmTriggerSelectionTagContainerConfig,
}
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1ufa7 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  | @as("revert-layer") RevertLayer
  | @as("unset") Unset
  | @as("none") NoneRevertEtc1ufa7
  | @as("block") Block
  | @as("inline") Inline
  | @as("run-in") RunIn
  | @as("-ms-flexbox") MsFlexbox
  | @as("-ms-grid") MsGrid
  | @as("-webkit-flex") WebkitFlex
  | @as("flex") Flex
  | @as("flow") Flow
  | @as("flow-root") FlowRoot
  | @as("grid") Grid
  | @as("ruby") Ruby
  | @as("table") Table
  | @as("ruby-base") RubyBase
  | @as("ruby-base-container") RubyBaseContainer
  | @as("ruby-text") RubyText
  | @as("ruby-text-container") RubyTextContainer
  | @as("table-caption") TableCaption
  | @as("table-cell") TableCell
  | @as("table-column") TableColumn
  | @as("table-column-group") TableColumnGroup
  | @as("table-footer-group") TableFooterGroup
  | @as("table-header-group") TableHeaderGroup
  | @as("table-row") TableRow
  | @as("table-row-group") TableRowGroup
  | @as("-ms-inline-flexbox") MsInlineFlexbox
  | @as("-ms-inline-grid") MsInlineGrid
  | @as("-webkit-inline-flex") WebkitInlineFlex
  | @as("inline-block") InlineBlock
  | @as("inline-flex") InlineFlex
  | @as("inline-grid") InlineGrid
  | @as("inline-list-item") InlineListItem
  | @as("inline-table") InlineTable
  | @as("contents") Contents
  | @as("list-item") ListItem
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1w3ez =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
type mozInitialOrInheritOrInitialOrRevertEtcoic7x =
  ...
  | @as("unset") Unset
  | @as("normal") Normal
  | @as("center") CenterRevertEtcoic7x
  | @as("stretch") Stretch
  | @as("end") EndRevertEtcoic7x
  | @as("flex-end") FlexEnd
  | @as("flex-start") FlexStart
  | @as("start") Start
  | @as("self-end") SelfEnd
  | @as("self-start") SelfStart
  | @as("anchor-center") AnchorCenter
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc96qi2 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcop7hp =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  | @as("revert-layer") RevertLayer
  | @as("unset") Unset
  | @as("none") NoneRevertEtcop7hp
  | @as("auto") Auto
  | @as("text") TextRevertEtcop7hp
  | @as("default") Default
  | @as("-moz-grab") MozGrab
  | @as("-moz-zoom-in") MozZoomIn
  | @as("-moz-zoom-out") MozZoomOut
  | @as("-webkit-grab") WebkitGrab
  | @as("-webkit-grabbing") WebkitGrabbing
  | @as("-webkit-zoom-in") WebkitZoomIn
  | @as("-webkit-zoom-out") WebkitZoomOut
  | @as("alias") Alias
  | @as("all-scroll") AllScroll
  | @as("cell") Cell
  | @as("col-resize") ColResize
  | @as("context-menu") ContextMenuRevertEtcop7hp
  | @as("copy") Copy
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcc55tl =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  | @as("revert-layer") RevertLayer
  | @as("unset") Unset
  | @as("none") NoneRevertEtcc55tl
  | @as("full-width") FullWidth
  | @as("capitalize") Capitalize
  | @as("full-size-kana") FullSizeKana
  | @as("lowercase") Lowercase
  | @as("math-auto") MathAuto
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1i3k7 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("FieldText") FieldText
  | @as("GrayText") GrayText
  | @as("Highlight") HighlightRevertEtc1i3k7
  | @as("HighlightText") HighlightText
  | @as("LinkText") LinkText
  | @as("Mark") Mark
  | @as("MarkText") MarkText
  ...
  | @as("Menu") Menu
  | @as("MenuText") MenuText
  | @as("Scrollbar") ScrollbarRevertEtc1i3k7
  | @as("ThreeDDarkShadow") ThreeDDarkShadow
  | @as("ThreeDFace") ThreeDFace
  | @as("ThreeDHighlight") ThreeDHighlight
  | @as("ThreeDLightShadow") ThreeDLightShadow
  ...
  | @as("WindowText") WindowText
  | @as("currentColor") CurrentColor
  | @as("context-fill") ContextFill
  | @as("context-stroke") ContextStroke
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcyzzvl =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc12qc2 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1tr76 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtcvavy2 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1270i =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("FieldText") FieldText
  | @as("GrayText") GrayText
  | @as("Highlight") HighlightRevertEtc1270i
  | @as("HighlightText") HighlightText
  | @as("LinkText") LinkText
  | @as("Mark") Mark
  | @as("MarkText") MarkText
  ...
  | @as("Menu") Menu
  | @as("MenuText") MenuText
  | @as("Scrollbar") ScrollbarRevertEtc1270i
  | @as("ThreeDDarkShadow") ThreeDDarkShadow
  | @as("ThreeDFace") ThreeDFace
  | @as("ThreeDHighlight") ThreeDHighlight
  | @as("ThreeDLightShadow") ThreeDLightShadow
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc12oc1 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  | @as("revert-layer") RevertLayer
  | @as("unset") Unset
  | @as("-apple-system") AppleSystem
  | @as("cursive") Cursive
  | @as("fantasy") Fantasy
  | @as("math") Math
  | @as("monospace") Monospace
  | @as("sans-serif") SansSerif
  | @as("serif") Serif
  | @as("system-ui") SystemUi
  | @as("ui-monospace") UiMonospace
  | @as("ui-rounded") UiRounded
  | @as("ui-sans-serif") UiSansSerif
  | @as("ui-serif") UiSerif
  | @as("emoji") Emoji
  | @as("fangsong") Fangsong
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc1cx47 =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  ...
  | @as("scroll") Scroll
  | @as("overlay") Overlay
  | @as("-moz-hidden-unscrollable") MozHiddenUnscrollable
  | @as("clip") Clip
  | @as("visible") Visible
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
@unboxed
type stringOrNumberOrContextComponentTokensTAGSSmMinWidthConfig =
  | Str(string)
  | Num(float)
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
...
type contextComponentTokensMULTISELECTV2SmTriggerSelectionTagConfig = {
  ...
  @as("no-container")
  noContainer?: contextComponentTokensMULTISELECTV2SmTriggerSelectionTagContainerConfig,
  marginLeft?: mozInitialOrInheritOrInitialOrRevertEtcrldf7,
  borderRadius?: mozInitialOrInheritOrInitialOrRevertEtcp2j1f,
}
...
@unboxed
type mozInitialOrInheritOrInitialOrRevertEtc2zoye =
  | @as("-moz-initial") MozInitial
  | @as("inherit") Inherit
  | @as("initial") Initial
  | @as("revert") Revert
  | @as("revert-layer") RevertLayer
  | @as("unset") Unset
  | @as("none") NoneRevertEtc2zoye
  | @as("normal") Normal
  | @as("auto") Auto
  | @as("top") Top
  | @as("right") RightRevertEtc2zoye
  | @as("bottom") Bottom
  | @as("left") LeftRevertEtc2zoye
  | @as("center") CenterRevertEtc2zoye
  | @as("border-box") BorderBox
  | @as("content-box") ContentBox
  | @as("padding-box") PaddingBox
  | @as("fill-box") FillBox
  | @as("stroke-box") StrokeBox
  | @as("view-box") ViewBox
  | Num(float)
  | ContextComponentTokensTAGSSmMinWidthConfig(contextComponentTokensTAGSSmMinWidthConfig)
