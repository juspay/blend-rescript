...
type rec selectMenuItemTypeV1mokb = {
  label: string,
  value: string,
  checked?: bool,
  subLabel?: string,
  ...
  disabled?: bool,
  onClick?: unit => unit,
  subMenu?: array<selectMenuItemTypeV1mokb>,
  tooltip?: React.element,
  tooltipProps?: singleSelectSelectMenuItemTypeTooltipPropsConfig,
  disableTruncation?: bool,
}
type selectMenuGroupTypeV196sm = {
  groupLabel?: string,
  items: array<selectMenuItemTypeV1mokb>,
  showSeparator?: bool,
}
...
type singleSelectProps = {
  ...
  placeholder: string,
  size?: selectMenuSize,
  items: array<selectMenuGroupTypeV196sm>,
