...
type chartTokensType = {
  border: string,
  borderRadius: string,
  axis: ChartsTypes.chartsChartTokensTypeAxisConfig,
  header: ChartsTypes.chartsChartTokensTypeHeaderConfig2,
  content: ChartsTypes.chartsChartTokensTypeContentConfig2,
}
