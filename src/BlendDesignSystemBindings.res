...
external getAvatarTokens: TokensTypes.foundationTokenType => AvatarTypes.responsiveAvatarTokens =
  "getAvatarTokens"
@module("@juspay/blend-design-system")
external getAvatarGroupTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => AvatarGroupTypes.responsiveAvatarGroupTokens = "getAvatarGroupTokens"
@module("@juspay/blend-design-system")
...
external getButtonTokens: TokensTypes.foundationTokenType => ButtonTypes.responsiveButtonTokens =
  "getButtonTokens"
@module("@juspay/blend-design-system")
external getButtonGroupTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => ButtonGroupTypes.responsiveButtonGroupTokens = "getButtonGroupTokens"
@module("@juspay/blend-design-system")
external getCardTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
...
external getColumnTypeConfig: DataTableTypes.columnType => DataTableTypes.columnTypeConfig =
  "getColumnTypeConfig"
@module("@juspay/blend-design-system")
external getTableToken: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => DataTableTypes.responsiveTableTokens = "getTableToken"
@module("@juspay/blend-design-system")
external getCalendarToken: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
...
external getTimePickerTokens: (
  ...
  ~theme: string=?,
  unit,
) => TimePickerTypes.responsiveTimePickerTokens = "getTimePickerTokens"
@module("@juspay/blend-design-system")
external getDirectoryTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
...
@module("@juspay/blend-design-system")
external getDropdownInputTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => InputsTypes.responsiveDropdownInputTokens = "getDropdownInputTokens"
@module("@juspay/blend-design-system")
...
external getOTPInputTokens: TokensTypes.foundationTokenType => InputsTypes.responsiveOTPInputTokens =
  "getOTPInputTokens"
@module("@juspay/blend-design-system")
external getUnitInputTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => InputsTypes.responsiveUnitInputTokens = "getUnitInputTokens"
@module("@juspay/blend-design-system")
...
external getModalComponentTokens: (
  ...
  ~theme: string=?,
  unit,
) => ModalTypes.responsiveModalTokens = "getModalComponentTokens"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external getSkeletonTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => SkeletonTypes.responsiveSkeletonTokens = "getSkeletonTokens"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external getSliderTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => SliderTypes.responsiveSliderTokens = "getSliderTokens"
@module("@juspay/blend-design-system")
external getSliderTokenStyles: (
  SliderTypes.sliderVariant,
  SliderTypes.sliderSize,
  ~tokens: SliderTypes.sliderTokensType=?,
  unit,
...
external getTopbarTokens: TokensTypes.foundationTokenType => TopbarTypes.responsiveTopbarTokens =
  "getTopbarTokens"
@module("@juspay/blend-design-system")
external getUploadTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => UploadTypes.responsiveUploadTokens = "getUploadTokens"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external getButtonV2BorderRadius: (
...
@module("@juspay/blend-design-system")
external getSkeletonBorderRadius: (
  ButtonV2Types.buttonV2Size,
  ButtonV2Types.buttonV2Type,
  ButtonV2Types.buttonV2SubType,
  ButtonTypes.buttonButtonGroupPosition,
...
@module("@juspay/blend-design-system")
external getCheckboxTextColor: (SelectorV2Types.checkboxV2TokensType, bool, bool) => string =
  "getCheckboxTextColor"
@module("@juspay/blend-design-system")
external getCheckboxSubtextColor: (SelectorV2Types.checkboxV2TokensType, bool, bool) => string =
  "getCheckboxSubtextColor"
@module("@juspay/blend-design-system")
external getCheckboxTextProps: (
  SelectorV2Types.checkboxV2TokensType,
...
@module("@juspay/blend-design-system")
external getPlainTextFromReactNode: React.element => string = "getPlainTextFromReactNode"
@module("@juspay/blend-design-system")
external filterBreadcrumbItemChildren: (
  React.element,
  React.component<BreadcrumbV2Types.breadcrumbCompoundItemProps>,
) => array<React.element> = "filterBreadcrumbItemChildren"
@module("@juspay/blend-design-system")
external indexBreadcrumbChildren: array<React.element> => array<
  BreadcrumbV2Types.indexedBreadcrumbChild,
...
@module("@juspay/blend-design-system")
external getInitialsFromText: (~text: string=?, unit) => string = "getInitialsFromText"
@module("@juspay/blend-design-system")
external sanitizeTextForLabel: string => string = "sanitizeTextForLabel"
@module("@juspay/blend-design-system")
external renderFallbackContent: (~fallbackText: string=?, ~alt: string=?, unit) => React.element =
...
@module("@juspay/blend-design-system")
external getProgressBarValueState: (
  float,
  float,
  float,
...
external parseCircularDashToken: (
  ...
  ~fallbackGap: float=?,
  unit,
) => (float, float) = "parseCircularDashToken"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external getSpinnerTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => SpinnerTypes.responsiveSpinnerTokens = "getSpinnerTokens"
@module("@juspay/blend-design-system")
external getEmptyStateTokens: (
  TokensTypes.foundationTokenType,
  ~theme: string=?,
  unit,
) => EmptyStateTypes.responsiveEmptyStateTokens = "getEmptyStateTokens"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external tabsV2Context: React.Context.t<TabsV2Types.tabsV2ContextValue> = "TabsV2Context"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external processTabsWithConcatenation: array<TabsV2Types.tabsV2TabItem> => array<
  TabsV2Types.tabsV2TabItem,
> = "processTabsWithConcatenation"
@module("@juspay/blend-design-system")
external prepareDropdownItems: (
...
@module("@juspay/blend-design-system")
external isConcatenatedTab: (string, Set.t<string>) => bool = "isConcatenatedTab"
@module("@juspay/blend-design-system")
external extractOriginalValues: string => array<string> = "extractOriginalValues"
@module("@juspay/blend-design-system")
external mergeItemsWithDefaultOrdering: (
  array<TabsV2Types.tabsV2TabItem>,
  Set.t<string>,
  Set.t<string>,
) => array<TabsV2Types.tabsV2TabItem> = "mergeItemsWithDefaultOrdering"
@module("@juspay/blend-design-system")
external applyTabItemDisplayDefaults: (
  array<TabsV2Types.tabsV2TabItem>,
  bool,
  bool,
  SkeletonTypes.skeletonVariant,
...
@module("@juspay/blend-design-system")
external scheduleLiveRegionAnnouncement: string => unit => unit = "scheduleLiveRegionAnnouncement"
@module("@juspay/blend-design-system")
external getStepState: (
  StepperV2Types.stepperV2Step,
  bool,
  bool,
) => StepperV2Types.stepperV2StepStatus = "getStepState"
@module("@juspay/blend-design-system")
...
@module("@juspay/blend-design-system")
external flattenSelectListV2Groups: array<SelectListV2Types.selectListV2GroupType> => array<
  SelectListV2Types.selectListV2Row,
> = "flattenSelectListV2Groups"
@module("@juspay/blend-design-system")
external countSelectListV2Options: array<SelectListV2Types.selectListV2Row> => float =
  "countSelectListV2Options"
@module("@juspay/blend-design-system")
external getSelectListV2FocusTargets: (
  array<SelectListV2Types.selectListV2Row>,
  SelectListV2Types.selectListV2GetSelectListV2FocusTargetsIsRowDisabledConfig => bool,
) => array<SelectListV2Types.selectListV2FocusTarget> = "getSelectListV2FocusTargets"
@module("@juspay/blend-design-system")
