...
module ColumnDefinition = {
  ...
  external fromDataTableColumnsReactElementConfig: dataTableColumnsReactElementConfig<'a> => t =
    "%identity"
  external asDataTableColumnsReactElementConfig: t => dataTableColumnsReactElementConfig<'a> =
    "%identity"
  external fromDataTableColumnsFilterTypeConfig: dataTableColumnsFilterTypeConfig<'a> => t =
    "%identity"
  external asDataTableColumnsFilterTypeConfig: t => dataTableColumnsFilterTypeConfig<'a> =
    "%identity"
}
