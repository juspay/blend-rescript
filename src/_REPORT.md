# Binding report — `@juspay/blend-design-system@0.0.38`
...
|---|---|---|---|
| `HighchartsSharedSharedTypes` | `Alt` | `"alt"` / `6` | `AltMultiCursorModifier`, `AltKeyCode`, `AltOptionsKeyValue`, `AltPanKeyValue` |
| `HighchartsSharedSharedTypes` | `Center` | `"center"` / `2` | `CenterAlignValue`, `CenterPopoverConfigAlign`, `CenterGlyphMarginLane`, `CenterMenuAlignment`, `CenterMenuV2Alignment`, `CenterPlacementStrategyValue`, `CenterRotationOriginValue`, `CenterOptionsStepValue`, `CenterTextAlignValue` |
| `HighchartsSharedSharedTypes` | `ContextMenu` | `"context-menu"` / `58` | `ContextMenuCursorValue`, `ContextMenuKeyCode` |
| `HighchartsSharedSharedTypes` | `CRLF` | `2` / `1` | `CRLFOfLine`, `CRLFLinePreference`, `CRLFLineSequence` |
| `HighchartsSharedSharedTypes` | `Ctrl` | `"ctrl"` / `5` | `CtrlKeyCode`, `CtrlOptionsKeyValue`, `CtrlPanKeyValue` |
| `HighchartsSharedSharedTypes` | `End` | `"end"` / `13` | `EndConfigAlign`, `EndKeyCode`, `EndMenuAlignment`, `EndV2Alignment`, `EndOriginValue` |
| `HighchartsSharedSharedTypes` | `Explicit` | `3` / `"explicit"` | `ExplicitCaretAnimation`, `ExplicitChangeReason` |
| `HighchartsSharedSharedTypes` | `Hover` | `"hover"` / `69` | `HoverActivatedOn`, `HoverEditorOption`, `HoverStateV2`, `HoverSelectionStates` |
| `HighchartsSharedSharedTypes` | `Insert` | `19` / `"insert"` | `InsertInsertMode`, `InsertKeyCode` |
| `HighchartsSharedSharedTypes` | `Item` | `{type: "item", …}` / `"item"` | `ItemFlatRow`, `ItemItemType` |
| `HighchartsSharedSharedTypes` | `Label` | `{type: "label", …}` / `"label"` | `LabelFlatRow`, `LabelItemType` |
| `HighchartsSharedSharedTypes` | `Left` | `"left"` / `1` | `LeftAlignValue`, `LeftEditorOutsidePosition`, `LeftPopoverConfigSide`, `LeftGlyphMarginLane`, `LeftMenuSide`, `LeftMenuV2Side`, `LeftInputV2Direction`, `LeftOptionsStepValue`, `LeftTextAlignValue`, `LeftV2DropdownPosition` |
| `HighchartsSharedSharedTypes` | `LF` | `1` / `0` | `LFOfLine`, `LFLinePreference`, `LFLineSequence` |
| `HighchartsSharedSharedTypes` | `Meta` | `"meta"` / `57` | `MetaKeyCode`, `MetaOptionsKeyValue`, `MetaPanKeyValue` |
| `HighchartsSharedSharedTypes` | `None` | `"none"` / `0` | `NoneOptionsAutohide`, `NoneAutoIndent`, `NoneLineHighlight`, `NoneRenderWhitespace`, `NoneSnippetSuggestions`, `NoneWrappingIndent`, `NoneCursorValue`, `NoneApproximationValue`, `NoneEndValue`, `NoneRenderMinimap` |
| `HighchartsSharedSharedTypes` | `Right` | `"right"` / `3` | `RightAlignValue`, `RightEditorOutsidePosition`, `RightPopoverConfigSide`, `RightGlyphMarginLane`, `RightMenuSide`, `RightMenuV2Side`, `RightInputV2Direction`, `RightOptionsStepValue`, `RightTextAlignValue`, `RightV2DropdownPosition` |
| `HighchartsSharedSharedTypes` | `Separator` | `{type: "separator", …}` / `"separator"` | `SeparatorFlatRow`, `SeparatorItemType` |
...
- `ChartsTypes`: `Long`, `Narrow`, `Numeric`, `Short`, `V2Digit`
...
| Prop | Real TypeScript |
|------|-----------------|
| `componentTokens` | `componentTokens?: ComponentTokenOverrides;` — binds, but references shared field(s) `contextComponentTokensTABLESmHeaderActionIconsColumnManagerTriggerConfig.opacity` (`review`), `contextComponentTokensTEXTAREAV2SmTopContainerLabelFontWeightConfig.sm` (`review`), `contextComponentTokensTEXTAREAV2SmTopContainerLabelFontWeightConfig.md` (`review`), `contextComponentTokensTEXTAREAV2SmTopContainerLabelFontWeightConfig.lg` (`review`) emitted as `string` |
