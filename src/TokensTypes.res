...
@set_index
external tokensFoundationTokenTypeBorderWidthConfigSet: (
  tokensFoundationTokenTypeBorderWidthConfig,
  string,
  string,
) => unit = ""
...
@set_index
external tokensFoundationTokenTypeBorderRadiusConfigSet: (
  tokensFoundationTokenTypeBorderRadiusConfig,
  string,
  string,
) => unit = ""
...
@set_index
external tokensFoundationTokenTypeOpacityConfigSet: (
  tokensFoundationTokenTypeOpacityConfig,
  string,
  string,
) => unit = ""
...
@set_index
external tokensFoundationTokenTypeUnitConfigSet: (
  tokensFoundationTokenTypeUnitConfig,
  string,
  JSON.t,
) => unit = ""
...
@set_index
external tokensFoundationTokenTypeZIndexConfigSet: (
  tokensFoundationTokenTypeZIndexConfig,
  string,
  string,
) => unit = ""
